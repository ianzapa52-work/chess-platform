  ...
  return (
    <div className="bg-black/50 [.light_&]:bg-white h-full flex flex-col border border-white/[0.07] [.light_&]:border-gray-200 rounded-[2.5rem] overflow-hidden shadow-2xl backdrop-blur-xl">
      <div className="px-6 py-5 border-b border-white/[0.05] [.light_&]:border-gray-100 flex justify-between items-center">
        <div>
          <p className="text-[10px] font-black tracking-[0.4em] text-zinc-500 [.light_&]:text-gray-500 uppercase">Movimientos</p>
          <p className={`text-sm font-bold mt-1 transition-colors duration-300 ${
            gameStarted
              ? 'text-white/80 [.light_&]:text-gray-900'
              : 'text-zinc-600 [.light_&]:text-gray-400'
          }`}>
      ...
      <div ref={scrollRef} className="flex-grow overflow-y-auto p-5 space-y-2 custom-scrollbar bg-gradient-to-b from-black/20 to-black/50 [.light_&]:from-gray-50 [.light_&]:to-gray-100/50">
        {rows.length === 0 ? (
      ...
      {isGameOver && (
        <div className="px-6 py-4 border-t border-white/[0.08] [.light_&]:border-gray-100 bg-gradient-to-r from-red-900/20 to-rose-900/10 [.light_&]:from-red-50 [.light_&]:to-rose-50">
          <p className="text-center text-[11px] font-black uppercase tracking-[0.3em]
            bg-red-500/20 [.light_&]:bg-red-100 border border-red-500/40 [.light_&]:border-red-300 px-4 py-2 rounded-2xl text-red-300 [.light_&]:text-red-700
      ...
      <div className="p-6 border-t border-white/[0.08] [.light_&]:border-gray-100 bg-gradient-to-b from-black/60 to-black/80 [.light_&]:from-gray-50 [.light_&]:to-gray-100">
        <button
          onClick={onReset}
