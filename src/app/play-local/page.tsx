...
function PlayerBox({ name, captured, isActive, seconds, isNoTimeMode, isTimedOut, isLight }: any) {
  ...
  return (
    <div className={`p-3 rounded-3xl border transition-all duration-500 relative overflow-hidden ${
      isTimedOut
      ...
      <div className="p-2 rounded-xl border border-black/30 shadow-inner min-h-[40px] flex items-center bg-linear-to-br from-[#d2b48c] to-[#a68a64] relative z-10">
    ...
    <main className={`min-h-[calc(100vh-5rem)] md:min-h-[calc(100vh-6rem)] xl:h-[calc(100vh-6rem)] ${isLight ? 'bg-[#f5f9ff]' : 'bg-[#020202]'} text-zinc-400 pt-3 px-4 pb-6 sm:px-6 xl:pt-5 xl:px-10 xl:pb-10 font-sans selection:bg-gold/30 relative overflow-y-auto xl:overflow-hidden`}>
      ...
      <div className="relative z-10 max-w-425 mx-auto grid grid-cols-12 gap-4 xl:gap-8 items-start">
        <div className="col-span-12 xl:col-span-3 flex flex-col gap-2 order-2 xl:order-1">
          ...
          <div className={`${panel} border rounded-3xl p-4 shadow-2xl backdrop-blur-xl`}>
            <div className="mb-3">
              <p className={`text-[10px] font-black tracking-[0.25em] ${labelText} uppercase mb-2 px-1`}>Elegir Bando</p>
            ...
            <div className="mb-3">
              <p className={`text-[10px] font-black tracking-[0.25em] ${labelText} uppercase mb-2 px-1`}>Configuración</p>
              <button
                disabled={gameStarted}
