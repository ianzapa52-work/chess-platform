...
export default function FriendsPage() {
  return (
    <>
      ...
      `}} />
      <div className="min-h-screen md:h-screen w-full flex flex-col relative overflow-y-auto md:overflow-hidden bg-[#050505] in-[.light]:bg-white">
        ...
        <div className="relative z-20 grow md:min-h-0">
          <FriendsForm />
        </div>
      </div>
    </>
