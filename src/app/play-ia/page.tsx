...
export default function PlayIAPage() {
  ...
  return (
    <main className={`h-[calc(100vh-5rem)] md:h-[calc(100vh-6rem)] ${isLight ? 'bg-[#fff7f8]' : 'bg-[#020202]'} text-zinc-400 pt-3 px-6 pb-6 xl:pt-5 xl:px-10 xl:pb-10 font-sans selection:bg-gold/30 relative overflow-hidden`}>
